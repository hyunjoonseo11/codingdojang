...
```
-----------------------------------
* [260번](https://codingdojang.com/scode/704)
...
```
-----------------------------------
* [266번](https://codingdojang.com/scode/711?answer=26313#answer_26313)
...
def find_the_number():
    ...
    while True:
        ...
        if a > i:
            ...
            print("정답입니다!{0}번 만에 맞췄어요.".format(result))  
            break  
